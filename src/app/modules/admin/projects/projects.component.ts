...
import { ProjectService } from 'app/modules/admin/projects/projects.service';
import { merge } from 'lodash';
import { Subject, switchMap, takeUntil } from 'rxjs';
import { AddProjectComponent } from './addproject/addproject.component';
import { ProjectDetailsComponent } from './details/details.component';
import { PaginationData, ProjectsTable } from './projects.types';
...
export class ProjectsListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        this._projectService.pagination$
    ...
    this.projects$ = this._projectService.projects$;
     ...
     console.log( this.projects$);
        ...
        openProjectDetails(id: string): void {
            ...
            const dialogRef = this._matDialog.open(ProjectDetailsComponent, {
                autoFocus: false,
                data: { projectid: id } // Pass project data to the dialog
            });
      ...
      addProject(): void {
        // Launch the modal
        const dialogRef = this._matDialog.open(AddProjectComponent, { autoFocus: false });
        ...
        merge(this._sort.sortChange, this._paginator.page)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.projectService.getProjects(params.page, params.limit, params.sort, params.order);
                })
            )
            .subscribe(() => {
