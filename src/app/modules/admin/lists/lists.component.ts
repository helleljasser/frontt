...
import { ListService } from 'app/modules/admin/lists/lists.service';
import { merge } from 'lodash';
import { Subject, switchMap, takeUntil } from 'rxjs';
import { AddListComponent } from './addlist/addlist.component';
import { ListDetailsComponent } from './details/details.component';
import { ListsTable, PaginationData } from './lists.types';
...
export class ListsListComponent implements OnInit, AfterViewInit, OnDestroy {
    [x: string]: any;
    ...
    selectedProject: ListsTable | null = null;
    ...
    this.lists$ = this._listService.lists$;
     ...
     console.log( this.lists$);
        ...
        openListDetails(id: string): void {
            // Pass data to the dialog component
            const dialogRef = this._matDialog.open(ListDetailsComponent, {
                autoFocus: false,
                data: { listid: id } // Pass list data to the dialog
            });
      ...
      addList(): void {
        // Launch the modal
        const dialogRef = this._matDialog.open(AddListComponent, { autoFocus: false });
...
ngAfterViewInit(): void {
        ...
        merge(this._sort.sortChange, this._paginator.page)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.listService.getLists(params.page, params.limit, params.sort, params.order);
                })
            )
            .subscribe(() => {
    ...
    trackByFn(index: number, item: ListsTable): string {
        return item.id;
    }
}
