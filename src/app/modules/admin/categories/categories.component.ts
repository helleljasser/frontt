...
import { CategoryService } from 'app/modules/admin/categories/categories.service';
import { merge } from 'lodash';
import { Subject, switchMap, takeUntil } from 'rxjs';
import { AddCategoryComponent } from './addcategory/addcategory.component';
import { CategoriesTable, PaginationData } from './categories.types';
...
export class CategoriesListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    selectedProject: CategoriesTable | null = null;
    ...
    this.categories$ = this._categoryService.categories$;
     ...
     console.log( this.categories$);
        ...
        opencategoryDetails(id: string): void {
            // Pass data to the dialog component
            const dialogRef = this._matDialog.open(CategoryDetailsComponent, {autoFocus: false,
                data: { categoryid: id } // Pass card data to the dialog
            });
      ...
      addCategory(): void {
        // Launch the modal
        const dialogRef = this._matDialog.open(AddCategoryComponent, { autoFocus: false });
...
ngAfterViewInit(): void {
        ...
        merge(this._sort.sortChange, this._paginator.page)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.categoryService.getCategories(params.page, params.limit, params.sort, params.order);
                })
            )
            .subscribe(() => {
    ...
    trackByFn(index: number, item: CategoriesTable): string {
        return item.id;
    }
}
