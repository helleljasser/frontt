...
import { TaskService } from 'app/modules/admin/taskss/tasks.service';
import { merge } from 'lodash';
import { Subject, switchMap, takeUntil } from 'rxjs';
import { TaskDetailsComponent } from './details/details.component';
import { TasksPagination, TasksTable } from './tasks.types';
...
export class TasksListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    selectedProject: TasksTable | null = null;
    ...
    ngOnInit(): void {
        ...
        this._testService.pagination$
            ...
            .subscribe((pagination: TasksPagination) => {
        ...
        // Get the tasks
        this.tasks$ = this._testService.tasks$;
    
        }
    
    
    openCardDetails(task: any): void {
        // Launch the modal
        const dialogRef = this._matDialog.open(TaskDetailsComponent, { autoFocus: false });
    console.log(task.id);
...
ngAfterViewInit(): void {
        ...
        merge(this._sort.sortChange, this._paginator.page)
            .pipe(
                ...
                switchMap(() => {
                    ...
                    return this.taskService.getTasks(params.page, params.limit, params.sort, params.order);
                })
            )
            .subscribe(() => {
    ...
    trackByFn(index: number, item: TasksTable): string {
        return item.id;
    }
}
